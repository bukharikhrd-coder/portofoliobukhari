      ...
      <div className="grid lg:grid-cols-12 gap-6 md:gap-8 items-center">
          <div className="lg:col-span-7 space-y-6 md:space-y-8 order-2 lg:order-1">
            ...
            >
              ...
              <TranslatedText className="text-muted-foreground text-xs md:text-sm tracking-[0.2em] md:tracking-[0.3em] uppercase">
                {heroData.subtitle}
              </TranslatedText>
            </motion.div>
            ...
            >
              <h1 className="font-display text-[clamp(2.5rem,10vw,10rem)] leading-[0.85] tracking-tight">
            ...
            >
              <TranslatedText as="p" className="text-muted-foreground text-base md:text-lg max-w-md leading-relaxed">
            ...
            >
              ...
              <a
                ...
                className="px-6 md:px-8 py-3 md:py-4 border border-border text-foreground font-medium tracking-wide hover:border-primary hover:text-primary transition-all duration-300 text-center text-sm md:text-base"
              >
          ...
          <div className="lg:col-span-5 relative order-1 lg:order-2">
            <motion.div
              ...
              className="absolute -top-2 right-0 lg:top-0 lg:right-0 text-right z-20"
            >
              <p className="text-muted-foreground text-xs md:text-sm tracking-[0.15em] md:tracking-[0.2em]">{heroData.date_display}</p>
              <p className="text-foreground font-medium mt-1 text-sm md:text-base">{heroData.brand_name}</p>
            </motion.div>
            ...
            <motion.div
              ...
              className="relative mt-10 md:mt-16 lg:mt-12"
